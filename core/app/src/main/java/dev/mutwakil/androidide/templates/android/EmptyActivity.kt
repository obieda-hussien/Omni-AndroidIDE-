...
import dev.mutwakil.androidide.project.manager.builder.toplevel.GradleFileType.GROOVY
import dev.mutwakil.androidide.project.manager.builder.toplevel.GradleFileType.KTS
      ...
      withContext(Dispatchers.IO) {
        try {
          ...
          val mainActivityContent =
              if (options.languageType == LanguageType.KOTLIN)
                  dev.mutwakil.androidide.templates.android.empty.EmptySources.mainActivityKotlin(
                      packageHelper.getPackageId()
                  )
              else
                  dev.mutwakil.androidide.templates.android.empty.EmptySources.mainActivityJava(
                      packageHelper.getPackageId()
                  )
